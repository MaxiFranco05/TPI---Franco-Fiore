"""Búsqueda de países por nombre, con sugerencias y paginación.

Permite buscar coincidencias exactas y aproximadas, mostrando resultados
formateados en consola o mediante paginación cuando la lista es extensa.
"""
    ...
    if len(match_pais) == 0:
        ...
        if len(possible_paises) > 0:
            if len(possible_paises) <= 5:
                ...
                # Si hay muchos resultados, usa paginación
